...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[scale=0.35]{figures/synthetic/tests_d=10.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[scale=0.07]{figures/friedman/statsplot_zoom.png}
...
whose mean is modelled by a shallow neural network and %whose variance is a
a single scalar
variance
...
\Cref{fig:synthetic_error_calibrated_1,fig:synthetic_error_calibrated_10,fig:synthetic_error_uncalibrated_1,fig:synthetic_error_uncalibrated_10} visualize the mean absolute error and the variance
...
the data sets used for the evaluation of the estimates). \Cref{fig:synthetic_error_calibrated_1,fig:synthetic_error_calibrated_10} illustrate that
...
\begin{figure}[hpt]
    \begin{center}
        \includegraphics[scale=0.35]{figures/synthetic/errors_model=calibratedmodel_d=1.pdf}
...
\begin{figure}[hpt]
    \begin{center}
        \includegraphics[scale=0.35]{figures/synthetic/errors_model=calibratedmodel_d=10.pdf}
        \caption{Mean absolute error and variance of 500 calibration error estimates for
        data sets of $n \in \{4, 16, 64, 256, 1024\}$ samples from the calibrated model
        of dimension $d = 10$.}
...
\begin{figure}[hpt]
    \begin{center}
        \includegraphics[scale=0.35]{figures/synthetic/errors_model=uncalibratedmodel_d=1.pdf}
        \caption{Mean absolute error and variance of 500 calibration error estimates for
...
\begin{figure}[hpt]
    \begin{center}
        \includegraphics[scale=0.35]{figures/synthetic/errors_model=uncalibratedmodel_d=10.pdf}
        \caption{Mean absolute error and variance of 500 calibration error estimates for
        data sets of $n \in \{4, 16, 64, 256, 1024\}$ samples from the uncalibrated model
        of dimension $d = 10$.}
...
\begin{figure}[hpt]
    \begin{center}
        \includegraphics[scale=0.35]{figures/synthetic/tests_d=1.pdf}
        \caption{Empirical test errors for 500 data sets of $n \in \{4, 16, 64, 256, 1024\}$
...
\begin{figure}[htp]
    \begin{center}
        \includegraphics[scale=0.07]{figures/friedman/statsplot.png}
