...
wsavefig("figures/synthetic/estimators_calibrated_model_dim=1.pdf")

plot_benchmark_estimators(calibrated_model; dim=10)
wsavefig("figures/synthetic/estimators_calibrated_model_dim=10.pdf")

plot_benchmark_estimators(uncalibrated_model; dim=1)
wsavefig("figures/synthetic/estimators_uncalibrated_model_dim=1.pdf")

plot_benchmark_estimators(uncalibrated_model; dim=10)
wsavefig("figures/synthetic/estimators_uncalibrated_model_dim=10.pdf")
...
wsavefig("figures/synthetic/tests_dim=1.pdf")

plot_benchmark_tests(; dim=10)
wsavefig("figures/synthetic/tests_dim=10.pdf")
